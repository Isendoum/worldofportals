...
export default class Shop extends PureComponent {
  ...
  buyItemFromShop = async (item) => {
    let wrappedObj = {
      ...
      shopId: this.state.info.shopInfo.id,
      itemId: item.id,
    };
    ...
    try {
      ...
      const response = await axios.post(
        localServer + 'rest/worldStructure/shop/buy',
        wrappedObj, config
      );
  ...
  sellItemToShop = async (item) => {
    ...
    try {
      ...
      const response = await axios.post(
        localServer + 'rest/worldStructure/shop/sell',
        wrappedObj, config
      );
  ...
  render() {
    return (
      <ImageBackground
        ...
        <Text style={styles.innTitle}>Inn</Text>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() =>
              this.setState({
                currentView: this.state.info.shopInfo.structureModel.shopList,
                currentViewType: 'shop',
              })
            }>
